if [ -f /home/gitolite/$GITOLITE_ADMIN_NAME.pub ]; then
...
if [ -n "$GITOLITE_ADMIN_KEY" ]; then
  ...
  echo "$GITOLITE_ADMIN_KEY" > /home/gitolite/$GITOLITE_ADMIN_NAME.pub
  return
fi

echo "No admin key provided, so it will be generated for you"
ssh-keygen -t rsa -b 2048 -f /home/gitolite/$GITOLITE_ADMIN_NAME -N ''

echo ""
echo "Generated admin's private key:"
cat /home/gitolite/$GITOLITE_ADMIN_NAME
echo ""
echo "Generated admin's public key:"
cat /home/gitolite/$GITOLITE_ADMIN_NAME.pub
echo ""
